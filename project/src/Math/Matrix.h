...
namespace dae {
	struct Matrix
	{
		...
		static Matrix CreateRotationX(float totalPitch);
		static Matrix CreateRotationY(float totalYaw);
		static Matrix CreateRotationZ(float totalRoll);
		static Matrix CreateRotation(float totalPitch, float totalYaw, float totalRoll);
